...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Uzzal15/UZZAL-KING/blob/main/Approval.txt').text
		ua=open('.bbnew.txt','w')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/Uzzal15/UZZAL-KING/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
